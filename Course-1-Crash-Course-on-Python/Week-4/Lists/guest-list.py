...
# profession of each party guest, and prints the sentence "Guest is X years old
# and works as __." for each one. For example, guest_list(('Ken', 30, "Chef"),
...
def guest_list(guests):
	for name, age, prof in [guest for guest in guests]:
